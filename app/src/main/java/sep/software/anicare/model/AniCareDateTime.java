...
public class AniCareDateTime {
	...
	public AniCareDateTime(String rawDateTime) {
	...
	public static AniCareDateTime getToday() {
		Time time = new Time();
		time.setToNow();
		return new AniCareDateTime(time.format("%Y%m%d000000"));
	}

	public AniCareDateTime getYesterday() {
		dateTime.set(dateTime.monthDay-1, dateTime.month, dateTime.year);
		dateTime.normalize(true);
		return new AniCareDateTime(dateTime.format("%Y%m%d000000"));
	}
