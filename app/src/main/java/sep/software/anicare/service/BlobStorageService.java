...
public class BlobStorageService {
	...
	private static boolean isExistSync(String containerName, String id) {
	...
	private static String uploadBitmapSync(String containerName, String id, Bitmap bitmap) {
		CloudBlobContainer container = null;
		CloudBlockBlob blob = null;
		try {
			container = blobClient.getContainerReference(containerName);
	...
	private static Bitmap downloadBitmapSync(String containerName, String id) {
		CloudBlobContainer container = null;
		CloudBlockBlob blob = null;
		Bitmap bm = null;
		try {
	...
	private static String downloadToFileSync(Context context, String containerName, String id, String path) {
		CloudBlobContainer container = null;
		CloudBlockBlob blob = null;
		try {
			container = blobClient.getContainerReference(containerName);
	...
	private static boolean deleteBitmapSync(String containerName, String id) {
		CloudBlobContainer container = null;
		CloudBlockBlob blob = null;
		try {
			container = blobClient.getContainerReference(containerName);
	...
	public static void isExistAsync(final String containerName, final String id, final EntityCallback<Boolean> callback) {
	...
	public static void uploadBitmapAsync(final String containerName, String id, final Bitmap bitmap, final EntityCallback<String> callback) {
	...
	public static void downloadBitmapAsync(final String containerName, String id, final EntityCallback<Bitmap> callback) {
	...
	public static void downloadToFileAsync(final Context context, final String containerName, String id, final String path, final EntityCallback<String> callback) {
	...
	public static void deleteBitmapAsync(final String containerName, String id, final EntityCallback<Boolean> callback) {
